...
This is a sample template for DankSpots - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name dankspots --tail
```
...
```bash
aws cloudformation delete-stack --stack-name dankspots
```
...
# Create S3 bucket
aws s3 mb s3://danksamrepo

# Package Lambda function defined locally and upload to S3 as an artifact
sam package \
    --output-template-file packaged.yaml \
    --s3-bucket danksamrepo
